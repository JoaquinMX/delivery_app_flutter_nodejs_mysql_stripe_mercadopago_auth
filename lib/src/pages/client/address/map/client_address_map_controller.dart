...
class ClientAddressMapController extends GetxController {
  ...
  Future setLocationDraggableInfo() async {
    ...
    if (address.isNotEmpty) {
      ...
      addressName.value = "$street$neighborhood$externalNumber, $city, $department";
  ...
  void updateLocation() async {
    try {
      ...
      animateCameraPosition(position?.latitude ?? 25.696974, position?.longitude ?? -100.316156);
    }
